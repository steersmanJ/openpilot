...
from selfdrive.car.honda.values import CarControllerParams, CruiseButtons, CruiseSetting, CAR, HONDA_BOSCH, HONDA_BOSCH_ALT_BRAKE_SIGNAL # added steers
...
class CarInterface(CarInterfaceBase):
  ...
  def update(self, c, can_strings):
    ...
    ret.readdistancelines = self.CS.read_distance_lines #added steers
